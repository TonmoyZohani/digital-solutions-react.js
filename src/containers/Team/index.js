...
import team2 from "../../assets/Images/team_4.jpg";
import team3 from "../../assets/Images/team_2.jpg";
import team4 from "../../assets/Images/team_3.jpg";
          ...
          <div className="col-lg-3 col-md-4 col-6">
            <div className="hometeam-box">
              <div class="our-team">
                ...
                <div class="team-content">
                  <h3 class="title">Kaisar Hamid</h3>
          ...
          <div className="col-lg-3 col-md-4 col-6">
            <div className="hometeam-box">
              <div class="our-team">
                ...
                <div class="team-content">
                  <h3 class="title">Jubayer Khan</h3>
                  <span class="post">Support</span>
                </div>
              </div>
            </div>
